...
class DBFVerticalTailMass(om.ExplicitComponent):
    ...
    def setup(self):
        # Still user inputs:
        add_aviary_input(self, Aircraft.VerticalTail.SPAN, units='m', meta_data=ExtendedMetaData)
        add_aviary_input(self, Aircraft.VerticalTail.ROOT_CHORD, units='m', meta_data=ExtendedMetaData)
        add_aviary_input(self, Aircraft.VerticalTail.WETTED_AREA, units='m**2', meta_data=ExtendedMetaData)

        add_aviary_output(self, Aircraft.VerticalTail.MASS, units='kg', meta_data=ExtendedMetaData)
