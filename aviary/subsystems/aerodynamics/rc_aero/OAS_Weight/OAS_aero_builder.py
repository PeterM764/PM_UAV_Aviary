...
class OASAeroBuilder(SubsystemBuilder):
    ...
    def build_mission(self, num_nodes, aviary_inputs, **kwargs):
        return OASAero(aviary_inputs=aviary_inputs,num_nodes=num_nodes)

    def mission_inputs(self, **kwargs):
        return [Dynamic.Mission.ALTITUDE, Dynamic.Mission.VELOCITY]
    
    def mission_outputs(self, **kwargs):
        return [Dynamic.Vehicle.DRAG, Dynamic.Vehicle.LIFT, 'alpha', 'aero_point_0.CL', 'aero_point_0.CD']
    
    def get_parameters(self, aviary_inputs=None, **kwargs):
        params = {}

        params[Aircraft.Wing.SPAN] = {'units': 'm', 'static_target': True}
        params[Aircraft.Wing.ROOT_CHORD] = {'units': 'm', 'static_target': True}
        params[Aircraft.Wing.SWEEP] = {'units': 'deg','static_target': True}
